          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_minmax(300px,40%)] lg:min-h-[min(88vh,640px)]">
            ...
            <div className="flex flex-col justify-center border-black/[0.06] p-8 sm:p-10 lg:border-e lg:p-12 xl:p-14">
              ...
              <motion.p
                ...
                className="mb-10 max-w-xl text-pretty text-base leading-relaxed text-dark/72 sm:text-lg"
              >
                {t.tagline}
              </motion.p>
                ...
                <div className="flex flex-wrap items-center gap-2 border-t border-black/[0.06] pt-6">
                  {socials.map((s, i) => (
                    <a
                      ...
                      aria-label={s.label}
                      className={cn(
                        'flex h-10 w-10 items-center justify-center rounded-lg border border-black/[0.06] bg-bg-deep/40 text-dark/48 transition-colors hover:border-primary/25 hover:bg-white hover:text-dark',
                        s.color
                      )}
                    >
                      {s.icon}
        ...
        <motion.div className="flex flex-col divide-y divide-dark/12 md:flex-row md:divide-y-0 md:divide-dark/12 md:divide-x rtl:md:divide-x-reverse">
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              <span className="text-label font-black uppercase tracking-widest text-dark/48">
            ...
            <p className="text-meta font-bold text-dark/58">{t.stats[0].label}</p>
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-label font-black uppercase leading-none text-dark/48">{t.stats[1].label}</p>
                <p className="mt-1 text-xl font-black tracking-tight text-dark">{t.stats[1].value}</p>
              </div>
            </div>
            <p className="text-meta font-medium italic leading-relaxed text-dark/58">
              {lang === 'en'
          ...
          >
            <div className="flex w-full flex-col gap-5 sm:flex-row sm:items-center sm:justify-between" dir="ltr">
              <div className={cn('min-w-0 flex-1', lang === 'ar' ? 'text-right' : 'text-left')}>
                <p className="mb-1 text-meta font-bold text-dark/48">{t.stats[2].label}</p>
